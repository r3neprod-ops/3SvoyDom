          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-7 grid gap-3 sm:grid-cols-3">
              {[
                ...
                <a key={item.label} href={item.href} className="glass-surface hover-lift rounded-xl border px-3 py-3 text-sm font-medium" style={{ borderColor: 'var(--border)' }}>
                  {item.label}
                </a>
              ))}
            </div>
...
function TrustMetrics() {
  ...
  return (
    <Section>
      <Container>
        <h2 className="mb-4 text-2xl font-semibold">Доверие и скорость</h2>
